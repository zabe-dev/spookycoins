...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'Rankings follow the votes hunters give each project. Boosted coins get extra vote power for a limited time, so they still have to compete while getting more visibility.',
  },
  {
...
function HomeFaq() {
  ...
  return (
    <section className="container home-faq" aria-labelledby="home-faq-title">
